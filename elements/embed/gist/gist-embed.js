...
import { } from '../../mkp/code/code-mkp.js';
...
export class GistEmbed extends HdElement {
  constructor() {
    ...
    this.defineAccessor('gist-id', async (id) => {
      if (!id) {
        return;
      }
      ...
      this['code-el'].colorize();
    });
    this.defineAccessor('highlight', (color) => {
      this.setStateProperty('hlColor', color);
    });
...
<code-mkp bind="textContent: gistSrc; @highlight: hlColor" id="code-el"></code-mkp>
